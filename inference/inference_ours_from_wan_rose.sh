#!/usr/bin/env bash
# SS4D inference on WAN I2V rose. (1) Rosemore_050016 fwd; (2) Rosemore_050047 rev. Data from create_ss4d_from_wan_rose.sh.
set -euo pipefail
...
run_sample "Rosemore_050016_090_from_wan_forward_s000_t${T_END}"
run_sample "Rosemore_050047_175_from_wan_reverse_s000_t${T_END}"
