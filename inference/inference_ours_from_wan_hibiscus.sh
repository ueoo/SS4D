#!/usr/bin/env bash
# SS4D inference on WAN I2V hibiscus. (1) Hibiscusmore_010054 fwd; (2) Hibiscusmore_010008 rev. Data from create_ss4d_from_wan_hibiscus.sh.
set -euo pipefail
...
run_sample "Hibiscusmore_010054_020_from_wan_forward_s000_t${T_END}"
run_sample "Hibiscusmore_010008_070_from_wan_reverse_s000_t${T_END}"
