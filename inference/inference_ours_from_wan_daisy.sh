#!/usr/bin/env bash
# SS4D inference on WAN I2V–derived frames. Data from create_ss4d_from_wan_daisy.sh.
set -euo pipefail
...
run_sample "Daisymorefix_020044_020_from_wan_forward_s000_t${T_END}"
run_sample "Daisymorefix_020044_080_from_wan_reverse_s000_t${T_END}"
