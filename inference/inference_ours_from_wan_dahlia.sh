#!/usr/bin/env bash
# SS4D inference on WAN I2V–derived frames (center-crop 512). Data from create_ss4d_from_wan_dahlia.sh.
set -euo pipefail
...
RENDER_VIEW_IDXS="0"
SEED=42
# Read 10 frames from indices 0..48 with step 5 (even length for model)
MAX_FRAMES=32
FRAME_STEP=1
T_END=48
...
run_sample "Dahliamorefix_020033_010_from_wan_forward_s000_t${T_END}"
run_sample "Dahliamorefix_020033_100_from_wan_reverse_s000_t${T_END}"
